...
25 REM ****************************** REM
30 REM FNM COMPUTES M MODULAR 7
35 REM FNN COMPUTES THE NEXT ONE TO GET THE BUTTON
40 DEF FNM(X)=(X=0 OR X=8)*1+(X>0 AND X<8)*X
45 DEF FNN(X)=FNM(X+SGN(RND(0)-.5))
50 GOSUB 1000
...
220 IF G=B THEN 430
230 IF G=L THEN 360
240 IF G=FNM(B+1_ OR G=FNM(B-1) THEN 340
...
420 GOTO 170
430 PRINT C;":  'RIGHT YOUR ARE - LUCKY!'"
440 REM *** AGAIN? ***
450 PRINT
...
1240 PRINT
1250 PRINT "IF YOU ANT TO STOP, TYPE 0 (ZERO)"
1260 PRINT
