...
140 IF Z$ <> "Y" THEN 290
150 PRINT
160 PRINT "I WILL THINK OF A NUMBER FROM 1 TO 100."
170 PRINT "TRY TO GUESS MY NUMBER. ENTER TWO NUMBERS, TRYING"
180 PRINT "TO TRAP MY NUMBER BY YOUR TWO TRAP NUMBERS. I'LL"
190 PRINT "TELL YOU IF YOU HAVE TRAPPED MY NUMBER OF IT MY"
200 PRINT "NUMBER IS SMALLER THAN YOUR TWO TRAP NUMBERS OR"
210 PRINT "IF MY NUMBER IS LARGER THA. YOUR TWO TRAP NUMBERS."
...
390 GOT T+3 OF 430,410,400,410,450
400 GOTO 430
