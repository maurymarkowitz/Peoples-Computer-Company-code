...
410 PRINT "PRESS THE 'RETURN' KET. AFTER EACH GUESS, I WILL"
420 PRINT "TELL YOU THE APPROXIMATE DIRECTION TO GO FOR YOUR"
430 PRINT "NEXT GUESS. GOOD LUCK!"
440 REM *** HURKLE 'PICKS' A GRIDPOINT AND HIDES
450 LET A=INT(10*RND(0))
460 LET B-INT(10*RND(0))
470 PRINT
480 PRINT "THE HURKLE IS HIDING - TRY TO FIND HIM!"
490 REM *** GET A GUESS AND PRINT INFO FOR THE PLAYER
500 LET K=1
510 PRINT
...
600 PRINT
610 PRINT "YOU FOUND HIM IN"K;"GUESSES!!!"
