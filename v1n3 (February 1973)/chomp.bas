...
250 PRINT "WIDE. YOU INUT R AND C AT THE START. IN THE UPPER LEFT"
...
430 INPUT R
440 IF R <= 9 THEN 470
450 PRINT "TO MANY ROWS (9 IS MAXIMUM). NOW, ";
460 GOTO 420
...
800 IF P1 <> 0 THEN 880
810 P1=P
820 PRINT "PLAYER ";P1
830 PRINT "COORDINATES OF CHOMP (ROW,COULUMN)";
840 INPUT R1,C1
...
910 GOTO 940
920 PRINT "NO FAIR. YOU'RE TRYING TO CHOMP AN EMPTY SPACE!"
930 GOTO 820
940 FOR I=R1 TO R
950 FOR J=C1 TO C
960 A[I,J]=0
